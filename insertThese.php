...
<i class="material-icons" style="font-size:48px;color:red;"class="btn btn-primary" data-toggle="modal" data-target="#myModal">person_add</i> 
    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h1 class="modal-title">Add a End of Study Project</h1>
 ...
 <form    action="insertfilière.php" method="POST"   >
                ...
                <input type="text" name="sujet" class="form-control" placeholder="sujet" required="" autofocus="">

              
                <input type="text" name="rapport" class="form-control" placeholder="rapport" required="" autofocus="">
           
           
                <input type="text" name="Etat_davancement" class="form-control" placeholder="Etat_davancement" required autofocus="">
                 
<div class="input-group">
  <button class="btn btn-md btn-block submit" name="ajouter1" type="submit"><i class="fas fa-user-plus"></i> Add</button>
</div>
