...
<br><br><br>
   <a href="acceuil.php"><i class='fas fa-home' style='font-size:36px'></i><span class="hidden-xs hidden-sm">Home</span></a> <br> 
                       
                        <li><a href="Etudiant.php"><i class='fas fa-user-graduate' style='font-size:36px'></i><span>Student</span></a> <br> 
                        <li><a href="professeur.php"><i class='fas fa-chalkboard-teacher' style='font-size:36px'></i><span>Professor</span></a> 
    ...
    <section class="codepen-style">
       <a href=""> <h1><span>Admin</span>istrateur</h1> </a>
