...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <marquee loop="17"><a class="navbar-brand" href="#"><span><strong> Memorizing notes </strong></span></a> </marquee>
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar collapse in" style="box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px;">
<br><br>
<ul class="nav menu">
      <li>  <a href="acceuil.php"> <div><img src="pen2.jpg" height="190" width="210"></div></a></li> <br><br>

      <li><a href="profil.php"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg><strong> My profile</strong></a></li>    

        <li><a href="aff_note.php"><svg class="glyph stroked blank document"><use xlink:href="#stroked-blank-document"></use></svg> <strong>Notes</strong> </a></li>

        <li><a href="aff_module.php"><svg class="glyph stroked open folder"><use xlink:href="#stroked-open-folder"></use></svg><strong> Modules</strong> </a></li>
      
      <li role="presentation" class="divider"></li>

      <li><a href="deconnect.php"><svg class="glyph stroked lock"><use xlink:href="#stroked-lock"></use></svg> <strong>Disconnect </strong></a></li>
    </ul>
</div>
                         ...
                         <select class="form-control" name="module">
                          <option selected="">Modules</option>
                                                                            ...
                                                                            <option value="11">database</option>
                                                                                 ...
                                                                                 <option value="19">Mathematical</option>
...
<script src="js/lumino.glyphs.js"></script><svg id="glyphs-sheet" xmlns="http://www.w3.org/2000/svg" style="display:none;"><defs><symbol id="stroked-bacon-burger" class="glyph-svg stroked" viewBox="0 0 44 44">
...
</symbol></defs></svg><style id="glyphs-style" type="text/css">
.glyph{
  fill:currentColor;
