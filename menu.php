...
<br> 
   ...
   <a href="Profile.php"> <i class='fas fa-user-graduate' style='font-size:36px'></i><br><spane>Profile</span></a>  
                       
      <a href="tableau.php" ><i class='far fa-sticky-note' style='font-size:30px'></i><br><span>Note</span></a> 
       <a href="tableau_module.php"><i class='fas fa-book-reader' style="font-size:30px"></i><br><span>Cours</span></a> 
              

                 <a  href='table_pfe.php'><i class='fas fa-chalkboard-teacher' style='font-size:30px'></i><br><span>end of studies project</span></a> 
       <a href="ind.php">  <i class="fa fa-commenting-o" style="font-size:29px"></i><span>Reclamation</span></a> 
                  <a href="tableLiveetd.php"><i class='fas fa-file-video' style='font-size:25px'></i><span>c</span></a>   

                 
                  <a href="deconnecter.php"><i class="glyphicon glyphicon-log-out" style='font-size:30px'></i><span>log-out</span></a>        
    ...
    <section class="codepen-style">
       <a href=""> <h1><span>Student </span>area</h1> </a>
